...
def main():
    ...
    # fastspeech2_default
    # 非量化模型
    model_dir = './fastspeech2_csmsc_static_1.4.0'
    precision = 'fp32'
    # 量化模型
    # model_dir = './fastspeech2_csmsc_quant'
    # precision = 'int8'
    
    '''fastspeech2_cnndecoder
    # 非量化模型
    model_dir = './fastspeech2_cnndecoder_csmsc_static_1.4.0'
    precision = 'fp32'
    # 量化模型
    # model_dir = './fastspeech2_cnndecoder_csmsc_quant'
    # precision = 'int8'
    '''
